...
if(isset($_POST["diseno"])){ $diseno="<img src='../images/check.png'/>";}
if(isset($_POST["productor"])){ $productor="<img src='../images/check.png'/>";}
if(isset($_POST["consultor"])){ $consultor="<img src='../images/check.png'/>";}
if(isset($_POST["asesor"])){ $asesor="<img src='../images/check.png'/>";}
if(isset($_POST["interventor"])){ $interventor="<img src='../images/check.png'/>";}
if(isset($_POST["obra"])){ $obra="<img src='../images/check.png'/>";}
if(isset($_POST["proveedor"])){ $proveedor="<img src='../images/check.png'/>";}
if(isset($_POST["instalador"])){ $instalador="<img src='../images/check.png'/>";}
if(isset($_POST["comprador"])){ $comprador="<img src='../images/check.png'/>";}
if(isset($_POST["propietario"])){ $propietario="<img src='../images/check.png'/>";}
if(isset($_POST["usuario"])){ $usuario="<img src='../images/check.png'/>";}
if(isset($_POST["mante"])){ $mante="<img src='../images/check.png'/>";}
if(isset($_POST["autor"])){ $autor="<img src='../images/check.png'/>";}
    ...
    <body>
        ...
        <table>
            <tbody>
                ...
                <tr>
                    <td colspan="4" >CIUDAD: ' . $_POST["ciudad"] . '</td>
                </tr>
            </tbody>
        </table>
        ...
        <div id="preguntas" class="margen col-xs-12">
           ...
           <table>
                    <tr>
                        <td class="check">' . $diseno . '</td>
                        <td> DISEÑADOR </td>
                        <td class="check">' . $productor . '</td>
                        <td> PRODUCTOR </td>
                    </tr>

                    <tr>
                        <td class="check">' . $consultor . '</td>
                        <td> CONSULTOR </td>
                        <td class="check">' . $asesor . '</td>
                        <td> ASESOR </td>
                    </tr>

                    <tr>
                        <td class="check">' . $interventor . '</td>
                        <td> INTERVENTOR </td>
                        <td class="check">' . $obra . '</td>
                        <td> RESPONSABLE DE LA OBRA </td>
                    </tr>

                    <tr>
                        <td class="check">' . $proveedor . '</td>
                        <td> PROVEEDOR </td>
                        <td class="check">' . $instalador . '</td>
                        <td> INSTALADOR </td>
                    </tr>

                    <tr>
                        <td class="check">' . $comprador . '</td>
                        <td> COMPRADOR </td>
                        <td class="check">' . $propietario . '</td>
                        <td> PROPIETARIO </td>
                    </tr>

                    <tr>
                        <td class="check">' . $usuario . '</td>
                        <td colspan="3"> USUARIO </td>
                    </tr>
                    <tr>
                        <td class="check">' . $mante . '</td>
                        <td colspan="3"> RESPONSABLE DE MANTENIMIENTO DE LAS INSTALACIONES </td>                    
                    </tr>
                    <tr>
                        <td class="check">' . $autor . '</td>
            ...
            <p class="bordes"><b>Observaciones:</b> ' . $obser . '</p>
            </div>
        </div>
        <div id="firma">
        <table>
